...
# Метод, позволяющий игроку делать ходы
    ...
    # Если все корректно то фигура съедается,а шашка перемещается за нее, а если фигура была съедена дамкой, то игрок вводит координаты куда нужно переместить дамку(эту часть лучше не показывать,баг)
